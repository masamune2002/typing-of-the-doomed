...
const SPRITE_PREFIX = "HEAD"
const IDLE_FRAMES = ["A"]
const ATTACK_FRAMES = ["B", "C", "D"]
const PAIN_FRAMES = ["F"]
const DEATH_FRAMES = ["G", "H", "I", "J", "K", "L"]
const ANGLE_ZERO_FRAMES = ["F", "G", "H", "I", "J", "K", "L"]
...
const PROJECTILE_SPRITE_PREFIX = "BAL1"
...
func _updateSprite() -> void:
	...
	if _sprites.has(spriteName):
		...
		print("Cacodemon: sprite '", spriteName, "' not found. Available: ", _sprites.keys())
