extends Enemy
class_name BaronOfHell

const SPRITE_PREFIX = "BOSS"
const IDLE_FRAMES = ["A", "B"]
const ATTACK_FRAMES = ["E", "F", "G"]
const PAIN_FRAMES = ["H"]
const DEATH_FRAMES = ["I", "J", "K", "L", "M", "N", "O"]
const ANGLE_ZERO_FRAMES = ["H", "I", "J", "K", "L", "M", "N", "O"]
...
const PROJECTILE_SPRITE_PREFIX = "BAL7"
...
func _updateSprite() -> void:
	...
	if _sprites.has(spriteName):
		...
		print("BaronOfHell: sprite '", spriteName, "' not found. Available: ", _sprites.keys())
...
func _startSpriteDeath() -> void:
	...
	_deathComplete = true
	var corpseKey = SPRITE_PREFIX + "O0"
