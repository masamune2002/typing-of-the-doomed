...
signal enemyPained(enemy : Enemy, wasAttacking : bool)
signal itemSpawned(item: Item)
...
signal levelExitReached()
signal episodeFinale()
signal weaponChanged()
signal interactableActivated(interactable_name : String)
signal doorOpened(door_name : String)
